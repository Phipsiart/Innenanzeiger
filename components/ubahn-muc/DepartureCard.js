            ...
            <div className="flex" key={index}>
              {index < 5 ? (
                <div className="h-[6rem]">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="fixed z-[9998] mt-[0.1rem] left-[13.8rem]" width="24" height="48" viewBox="0 0 24 48" fill="none" stroke="#4b5563" strokeWidth="7" >
  <line x1="12" y1="0" x2="12" y2="33"/>
</svg>
                  <svg xmlns="http://www.w3.org/2000/svg" className="fixed mt-[1.53rem]  left-[13.05rem]" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#4b5563" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
  <circle cx="12" cy="12" fill="none" r="6"/>
</svg>
<svg xmlns="http://www.w3.org/2000/svg" className="fixed z-[9998] mt-[3.9rem]  left-[13.8rem]" width="24" height="48" viewBox="0 0 24 48" fill="none" stroke="#4b5563" strokeWidth="7" >
  <line x1="12" y1="0" x2="12" y2="36"/>
                ...
                <div className="h-[6rem] mt-4 z-[900]">
                  ...
                  <AvailableTypesofConnections products={stop.typeofconnections} mainscreen={true} />
                  <svg xmlns="http://www.w3.org/2000/svg" className='fixed left-[13.8rem]' width="24" height="80" viewBox="0 0 24 80">
