...
type TableRowProps = React.HTMLAttributes<HTMLTableRowElement> & { tripId?: string };

const TableRow = React.forwardRef<HTMLTableRowElement, TableRowProps>(({ className, tripId, ...props }, ref) => {
  ...
  return (
    <tr
      ...
      onClick={() => RedirectToInnenanzeiger(tripId)}
      {...props}
    />
  );
});
